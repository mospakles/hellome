      ...
      <div className="container mx-auto md:p-8 p-2">
        <div className="flex justify-between p-4 md:px-10 cursor-pointer">
          <div className="md:mr-0 mr-2">
            <h3 className="md:text-xl text-lg font-bold mb-8">Who are we</h3>
            <ul className="mt-4">
          ...
          <div className="md:ml-0 ml-2">
            <h3 className="md:text-xl text-lg font-bold mb-8">Legal</h3>
            <ul className="mt-4">
          ...
          <div className="md:ml-0 ml-2">
            <h3 className="md:text-xl text-lg font-bold mb-8">Contact us</h3>
            <div>
              <p className="mb-5">
