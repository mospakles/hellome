...
const Navbar = () => {
  ...
  return (
    <div className="bg-black px-4 py-2 font-clash-variable">
      <div className="flex justify-between items-center">
        <div className="flex items-center">
          ...
          <div className="hidden md:flex justify-center items-center gap-14 text-white ml-8">
            ...
            <div className="relative" ref={dropdownRef}>
              ...
              {isOpen && (
                <div className="absolute z-10 left-0 mt-2 bg-black rounded shadow-md w-full">
                  <div className="py-2">
        ...
        <div className="hidden md:flex justify-center items-center gap-5 p-3">
          <div className="text-white border-2 rounded-full py-2 text-center px-4">
            Login
          </div>
          <div className="text-white border-2 rounded-full py-2 px-4">
            Sign up
          </div>
        </div>
      </div>
      {isOpen && (
        <div className="md:hidden absolute left-0 top-16 w-full bg-black py-2">
          <div className="text-white text-center p-2">Personal Account</div>
          <div className="text-white text-center p-2">Business Account</div>
          <div className="text-white text-center p-2">Company</div>
          <div className="text-white text-center border-t border-gray-200 py-2">
            Login
          </div>
          <div className="text-white text-center">Sign Up</div>
        </div>
      )}
    </div>
  );
